...
menu-about = Derbarê { earth-files }...
...
size = Mezinahî
type-heading = Cûre
file-type-folder = Peldank
file-type-image = Wêne
file-type-video = Vîdyo
file-type-audio = Deng
file-type-text = Nivîs
file-type-archive = Arşîv
file-type-document = Belge
file-type-program = Bername
file-type-other = Ên din
details = Hûrgilî
pause = Rawestîne
resume = Bidomîne
