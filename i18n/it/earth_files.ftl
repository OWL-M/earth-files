...
size = Dimensione
type-heading = Tipo
file-type-folder = Cartella
file-type-image = Immagine
file-type-video = Video
file-type-audio = Audio
file-type-text = Testo
file-type-archive = Archivio
...
extract-as-folder = Estrai in cartella
