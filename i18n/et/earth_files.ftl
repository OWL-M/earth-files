...
size = Suurus
type-heading = Tüüp
file-type-folder = Kaust
file-type-image = Pilt
file-type-video = Video
file-type-audio = Heli
file-type-text = Tekst
file-type-archive = Arhiiv
...
show-type-column = Näita tüübi veergu
...
menu-about = Rakenduse teave: { earth-files }...
sort = Järjesta
sort-a-z = A-Z
sort-z-a = Z-A
