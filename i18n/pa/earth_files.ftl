...
size = ਆਕਾਰ
type-heading = ਕਿਸਮ
file-type-folder = ਫੋਲਡਰ
file-type-image = ਚਿੱਤਰ
file-type-video = ਵੀਡੀਓ
file-type-audio = ਆਡੀਓ
file-type-text = ਲਿਖਤ
file-type-archive = ਅਕਾਇਵ
file-type-document = ਦਸਤਾਵੇਜ਼
...
show-type-column = ਕਿਸਮ ਕਾਲਮ ਵੇਖੋ
