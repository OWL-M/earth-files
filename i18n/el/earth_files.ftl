...
size = Μέγεθος
type-heading = Τύπος
file-type-folder = Φάκελος
file-type-image = Εικόνα
file-type-video = Βίντεο
file-type-audio = Ήχος
file-type-text = Κείμενο
file-type-archive = Συμπιεσμένο αρχείο
file-type-document = Έγγραφο
file-type-program = Πρόγραμμα
file-type-other = Άλλο
...
menu-about = Σχετικά με τα { earth-files }...
