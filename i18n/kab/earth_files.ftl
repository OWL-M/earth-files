...
size = Tiddi
type-heading = Anaw
file-type-folder = Akaram
file-type-image = Tugna
file-type-video = Tavidyut
file-type-audio = Ameslaw
file-type-text = Aḍris
file-type-archive = Aɣbar
file-type-document = Isemli
file-type-program = Ahil
file-type-other = Ayen nniḍen
details = Ifatusen
pause = Serǧu
resume = Kemmel
...
renaming-many = Abeddel n yisem n { item-count }
renamed-many = Yettwabeddel yisem n { item-count }
...
show-type-column = Sken tagejdit n wanaw
gallery-preview = Taskant n temidelt
menu-about = Ɣef { earth-files }…
sort = Asmizzwer
...
sort-type-a-z = Anaw A-Ẓ
sort-type-z-a = Anaw Ẓ-A
