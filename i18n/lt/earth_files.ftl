...
size = Dydis
type-heading = Tipas
file-type-folder = Aplankas
file-type-image = Paveikslėlis
file-type-video = Vaizdo įrašas
file-type-audio = Garso įrašas
file-type-text = Tekstas
file-type-archive = Archyvas
...
sort-type-a-z = Tipas A-Ž
sort-type-z-a = Tipas Ž-A
dark = Tamsus
light = Šviesus
comment = Failų tvarkyklė
