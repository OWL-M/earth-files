...
size = Boyut
type-heading = Tür
file-type-folder = Klasör
file-type-image = Resim
file-type-video = Video
file-type-audio = Ses
file-type-text = Metin
file-type-archive = Arşiv
...
sort-type-a-z = Tür A-Z
sort-type-z-a = Tür Z-A
repository = Depo
support = Destek
remove = Kaldır
