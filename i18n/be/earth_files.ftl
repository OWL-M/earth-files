...
file-type-image = Выява
file-type-video = Відэа
file-type-audio = Аўдыё
file-type-text = Тэкст
file-type-archive = Архіў
...
sort-type-a-z = Тып А-Я
sort-type-z-a = Тып Я-А
