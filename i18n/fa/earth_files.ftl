...
size = حجم
type-heading = نوع
file-type-folder = پوشه
file-type-image = تصویر
file-type-video = ویدیو
file-type-audio = صدا
file-type-text = متن
file-type-archive = بایگانی
...
renaming-many = در حال تغییر نام { item-count }
renamed-many = { item-count } تغییر نام داده شد
