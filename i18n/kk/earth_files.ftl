...
size = Өлшемі
type-heading = Түрі
file-type-folder = Бума
file-type-image = Сурет
file-type-video = Бейне
file-type-audio = Аудио
file-type-text = Мәтін
file-type-archive = Архив
file-type-document = Құжат
...
sort-type-a-z = Түрі А-Я
sort-type-z-a = Түрі Я-А
