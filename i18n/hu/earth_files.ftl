...
file-type-text = Szöveg
file-type-archive = Archívum
...
sort-type-a-z = Típus A-Z
sort-type-z-a = Típus Z-A
repository = Tároló
support = Támogatás
