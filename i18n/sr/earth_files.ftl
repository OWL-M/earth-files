...
menu-about = О програму { earth-files }...
...
show-type-column = Прикажи колону врсте
...
renaming-many = Преименовање: { item-count }
renamed-many = Преименовано: { item-count }
