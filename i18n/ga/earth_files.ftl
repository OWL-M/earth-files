...
size = Méid
type-heading = Cineál
file-type-folder = Fillteán
file-type-image = Íomhá
file-type-video = Físeán
file-type-audio = Fuaim
file-type-text = Téacs
file-type-archive = Cartlann
...
sort-type-a-z = Cineál A-Z
sort-type-z-a = Cineál Z-A
repository = Stór
support = Tacaíocht
