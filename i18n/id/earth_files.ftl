...
show-type-column = Tampilkan kolom jenis
list-directories-first = Daftar direktori terlebih dahulu
menu-settings = Pengaturan...
menu-about = Tentang { earth-files }...
sort = Urutkan
sort-a-z = A-Z
sort-z-a = Z-A
...
sort-type-a-z = Jenis A-Z
sort-type-z-a = Jenis Z-A
