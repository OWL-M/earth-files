...
size = Stærð
type-heading = Gerð
file-type-folder = Mappa
file-type-image = Mynd
file-type-video = Myndskeið
file-type-audio = Hljóð
file-type-text = Texti
file-type-archive = Safnskrá
...
sort-type-a-z = Gerð A-Ö
sort-type-z-a = Gerð Ö-A
progress = { $percent }%
