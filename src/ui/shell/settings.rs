...
pub struct Settings {
    ...
    /// Whether the window should be resizable, and the size of the window
    /// border which can be dragged for a resize.
    ...
    pub(crate) size: crate::ui::iced::Size,
...
impl Default for Settings {
    fn default() -> Self {
        Self {
            ...
            debug: false,
            default_font: crate::ui::font::default(),
            ...
            scale_factor: std::env::var("COSMIC_SCALE")
                ...
                .unwrap_or(1.0),
            size: crate::ui::iced::Size::new(1024.0, 768.0),
            size_limits: Limits::NONE.min_height(1.0).min_width(1.0),
            theme: crate::ui::theme::system_preference(),
            transparent: true,
            exit_on_close: true,
            is_daemon: true,
        }
