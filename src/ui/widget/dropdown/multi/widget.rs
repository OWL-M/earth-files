...
impl<'a, S: AsRef<str>, Message: 'a, Item: Clone + PartialEq + 'static>
    From<Dropdown<'a, S, Message, Item>> for crate::ui::Element<'a, Message>
{
...
pub struct State<Item: Clone + PartialEq + 'static> {
    ...
    selections: Vec<(Item, crate::ui::widget::dropdown::Plain)>,
    descriptions: Vec<crate::ui::widget::dropdown::Plain>,
}
