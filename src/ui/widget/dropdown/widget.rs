    ...
    [S]: std::borrow::ToOwned,
{
    ...
    fn draw(
        ...
        let font = self.font.unwrap_or_else(crate::ui::font::default);
        draw(
            renderer,
            theme,
            layout,
...
> From<Dropdown<'a, S, Message, AppMessage>> for crate::ui::Element<'a, Message>
where
    [S]: std::borrow::ToOwned,
{
...
pub struct State {
    ...
    hashes: Vec<u64>,
    selections: Vec<crate::ui::widget::dropdown::Plain>,
    popup_id: window::Id,
}
...
pub fn layout(
    ...
    text_line_height: text::LineHeight,
    font: Option<crate::ui::font::Font>,
    selection: Option<(&str, &mut crate::ui::widget::dropdown::Plain)>,
            ...
            let measure = move |(label, paragraph): (_, Option<&mut crate::ui::widget::dropdown::Plain>)| -> f32 {
                let paragraph = match paragraph {
                    ...
                    None => {
                        ...
                        &mut crate::ui::widget::dropdown::Plain::new(text)
                    }
                };
...
pub fn overlay<'a, S: AsRef<str> + Send + Sync + Clone + 'static, Message: std::clone::Clone + 'a>(
    ...
    _font: Option<crate::ui::font::Font>,
    selections: &'a [S],
    icons: &'a [icon::Handle],
    selected_option: Option<usize>,
