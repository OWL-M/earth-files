...
impl<'a, Message: Clone + 'static> ListColumn<'a, Message> {
    ...
    #[inline]
    pub fn style(mut self, style: <crate::ui::Theme as Catalog>::Class<'a>) -> Self {
        self.style = style;
        self
    }
    ...
    pub fn into_element(self) -> Element<'a, Message> {
        ...
        let radius_s = crate::ui::theme::active().cosmic().radius_s();
        let mut col = crate::ui::widget::Column::with_capacity((2 * count).saturating_sub(1));
        ...
        ) in self.children.into_iter().enumerate()
        {
            ...
            col = match item {
                ...
                ListItem::Button(ListButton {
                    ...
                    let button: Element<'a, Message> = content_row(content)
