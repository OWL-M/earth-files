...
pub fn responsive_container<'a, Message: 'static, Theme, E>(
    content: E,
    id: Id,
    on_action: impl Fn(crate::ui::surface::Action<Message>) -> Message + 'static,
) -> ResponsiveContainer<'a, Message, Theme, crate::ui::Renderer>
where
...
where
    Renderer: crate::ui::iced_core::Renderer,
{
    content: Element<'a, Message, Theme, Renderer>,
    id: Id,
    size: Option<Size>,
    on_action: Box<dyn Fn(crate::ui::surface::Action<Message>) -> Message>,
}
    ...
    Renderer: crate::ui::iced_core::Renderer,
{
    ...
    fn size(&self) -> crate::ui::iced_core::Size<Length> {
...
where
    Message: 'a,
    Renderer: 'a + crate::ui::iced_core::Renderer,
    Theme: 'a,
{
    fn from(
