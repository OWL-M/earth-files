    ...
    Message: Clone + 'static,
{
    ...
    let mut input = TextInput::new(placeholder, value)
        .padding([0, spacing])
        .style(crate::ui::theme::TextInput::Default)
        .leading_icon(
            crate::ui::widget::icon::from_name("system-lock-screen-symbolic")
                .size(16)
                .apply(crate::ui::widget::container)
                .padding(8)
                .into(),
    ...
    if let Some(msg) = on_visible_toggle {
        input.trailing_icon(
            crate::ui::widget::icon::from_name(if hidden {
                "document-properties-symbolic"
            } else {
                "image-red-eye-symbolic"
            })
            .size(16)
            .apply(crate::ui::widget::button::custom)
    ...
    Message: Clone + 'static,
{
    ...
    pub fn on_clear(self, on_clear: Message) -> Self {
        self.trailing_icon(
            crate::ui::widget::icon::from_name("edit-clear-symbolic")
                .size(16)
                .apply(crate::ui::widget::button::custom)
                .class(crate::ui::theme::Button::Icon)
                .on_press(on_clear)
    ...
    fn sync_from_state(&mut self, tree: &mut Tree) {
        ...
        if self.manage_value && self.value.is_empty() {
        ...
        if self.is_editable_variant {
            ...
            self.trailing_icon = Some(
                crate::ui::widget::icon::from_name(icon_name)
                    .size(16)
                    .apply(crate::ui::widget::container)
                    .padding(8)
                    .into(),
    ...
    Message: Clone + 'static,
{
    ...
    fn diff(&self, tree: &mut Tree) {
        ...
        // The editable variant always carries a placeholder trailing icon from its
        // constructor, and `sync_from_state` only swaps it for another
        // `container(icon)`, so the child count here is the same either way.
        ...
        match state.cursor.state(value) {
            ...
            cursor::State::Selection { start, end } => {
                ...
                if dnd_icon {
                    ...
                    let rects = crate::ui::widget::paragraph::highlight(
                        state.value.raw(),
                        0,
...
pub struct State {
    ...
    pub(crate) menu_bar_state: crate::ui::widget::menu::MenuBarState,
    pub(crate) pending_action: crate::ui::widget::text_context_menu::PendingAction,
}
...
impl State {
    ...
    pub fn focused(is_secure: bool, is_read_only: bool) -> Self {
        Self {
            ...
            menu_bar_state: crate::ui::widget::menu::MenuBarState::default(),
...
impl<Message: Clone + 'static> crate::ui::widget::text::HasSelectableText
