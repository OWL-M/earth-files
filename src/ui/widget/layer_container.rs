...
//! Vendored from pop-os/libcosmic d9431dc, src/widget/layer_container.rs
...
{
    layer: Option<crate::ui::theme::Layer>,
    ...
    // iced_widget::container::Style: From<crate::theme::Container>,
{
    ...
    #[must_use]
    pub fn layer(mut self, layer: crate::ui::theme::Layer) -> Self {
        self.layer = Some(layer);
        self.class(match layer {
            crate::ui::theme::Layer::Background => crate::ui::theme::Container::Background,
            crate::ui::theme::Layer::Primary => crate::ui::theme::Container::Primary,
            crate::ui::theme::Layer::Secondary => crate::ui::theme::Container::Secondary,
        })
    }
    ...
    #[must_use]
    pub fn class(mut self, style: impl Into<crate::ui::theme::style::iced::Container<'a>>) -> Self {
